            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  {isActive && (
                    <Star size={12} className="text-violet-400 animate-pulse" />
                  )}
                </div>
                <motion.span
                  key={p.score}
          ...
          <div className="flex flex-wrap gap-1 max-h-28 overflow-y-auto">
            {[...wordsFound]
              ...
              .map((w, i) => (
                <span
                  key={i}
                  className="bg-emerald-500/15 text-emerald-300 text-xs px-2 py-0.5 rounded-full border border-emerald-500/20 font-mono"
                >
                  {w}
                </span>
              ))}
