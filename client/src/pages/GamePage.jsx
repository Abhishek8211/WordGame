        ...
        >
          ...
          <div className="flex flex-col gap-2 w-full">
            {sorted.map((p, i) => (
              <div
                key={p.id}
                className={`flex justify-between px-4 py-3 rounded-xl ${i === 0 ? "bg-amber-500/20 border border-amber-500/30" : "bg-white/5"}`}
              >
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-white/8 glass-card rounded-none">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Zap
              size={14}
              className={isMyTurn ? "text-violet-400" : "text-white/30"}
            />
